...
size_t NetworkSequenceCollection::controlTrimRound(unsigned trimLen)
{
	...
	if (numRemoved > 0)
        ...
        if(trimLen == 4){
            cout<<"DEBUG: before master synchronyzation\n";
        }
